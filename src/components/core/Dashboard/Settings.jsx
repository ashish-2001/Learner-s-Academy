...
import { deleteAccount, updateAdditionalDetails, updatePassword } from "../../../services/operations/profileAPI";
...
const Settings = () => {
    ...
    const profilePicture = useSelector((state) => state.profile.user.image);
                ...
                <div className="mx-auto w-11/12 max-w[100px] py-10">
                    ...
                    <div className="flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 md:p-8 md:px-12 px-3 py-3 text-richblack-5">
                        <div className="flex items-center gap-x-4">
                            <img className="aspect-square w-[78px] rounded-full object-cover" src={profilePicture}/>
                            <div className="space-y-2">
                                <p>Change Profile Picture</p>
                                <form onSubmit={handleUpload}>
                                    <div className="flex flex-row gap-3">
                                        <label className="cursor-pointer rounded-md bg-richblack-700 py-2 px-5 font-semibold text-richblack-50'" htmlFor="upload">
                                            Select
                                            <input 
                                                id="upload"
                                                type="file"
                    ...
                    <form onSubmit={handleAdditionalDetails}>
                        ...
                        <div className="flex justify-end gap-2">
                            <button 
                                className="flex items-center bg-yellow-300 cursor-pointer gap-x-2 rounded-md py-2 px-5 font-semibold text-richblack-900 undefined"
                                type="submit"
                            >
                                Save
                            </button>
                        ...
                        <div>
                            <div className="relative mt-4">
                                <label className="w-full">
                                    <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">Old Password <sup className="text-red-600">*</sup></p>
                                    <input
                                        required
                            ...
                            <div className="relative mt-4">
                                <label className="w-full">
                                    <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">New Password <sup className="text-red-600">*</sup></p>
                                    <input
                                        required
                            ...
                            <div className="relative mt-4">
                                ...
                                <span onClick={() => setShowConfirmPassword((prev) => !prev)} className="absolute right-3 top-10 z-[10] cursor-pointer">
                                    {showConfirmPassword ? (
                                        <AiOutlineEyeInvisible fontSize={24} fill="#AFB2BF" color="white" className=""/>
                                    ) : (
                                        <AiOutlineEye fontSize={24} fill="#AFB2BF" color="white"/>
