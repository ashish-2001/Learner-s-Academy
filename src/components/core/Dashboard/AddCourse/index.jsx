    ...
    return (
        <>
            <div className="flex w-full items-start gap-x-6">
                ...
                <div className="sticky top-10 hidden max-w-[400px] flex-1 rounded-md border-[1px] border-white bg-blue-950 p-6 xl:block">
                    <p className="mb-8 text-lg text-white5">Course upload tips</p>
