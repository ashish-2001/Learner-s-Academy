        ...
        <div>
            ...
            {loading ? (
                    ...
                    <div>
                        <div className="my-4 flex h-[450px] space-x-4">
                            {totalAmount > 0 || totalStudents > 0 ? (
                                <Instructor courses={instructorData}/>
                            ) : (
                                <div className="flex rounded-md bg-richblack-800 p-6">
                                ...
                                {courses.slice(0, 3).map((course) => (
                                    <div className="w-1/3" key={course._id}>
                                        ...
                                        <div className="mt-3 w-full">
                                            <p className="text-sm font-medium text-ricbblack-50">
                                                {course.courseName}
                                            </p>
                ...
                <div className="mt-20 rounded-md bg-richblack-800 p-6 py-20">
                    ...
                    <p className="mt-1 text-center text-lg font-semibold text-yellow-50">Create a course</p></Link>
                </div>
            )}
        </div>
    )
