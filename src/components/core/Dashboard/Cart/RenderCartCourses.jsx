        ...
        <div className="flex flex-1 flex-col">
            {cart.map((course, index) => (
                <div className={`flex w-full flex-wrap items-start justify-between gap-6 ${
                    index !== cart.length - 1 && "border-b-blue-950 pb-6" 
                    ...
                    <div className="flex flex-col items-end space-y-2">
                        <button onClick={() => dispatch(removeFromCart(course._id))} className="flex items-center gap-x-1 rounded-md border border-white bg-blue-950 py-3 px-[12px] text-pink-600">
                            <RiDeleteBin6Line/>
                            <span>Remove</span>
                        </button>
