        ...
        <div>
            ...
            <div className="flex flex-col gap-5 lg:flex-row">
                <div className="flex flex-col gap-2 lg:w-[48%]">
                    ...
                    <input type="text" name="firstName" id="firstName" placeholder="Enter first name!" className="rounded-lg bg-[#2C333F] p-3 text-[16px] leading-[24px] text-[#F1F2FF] shadow-[0_1px_0_0] shadow-[#fff]/50 placeholder:text-[#6E727F] focus:outline-none"
                        { ...register("firstName", { required: true })} 
                    />
                        { errors.firstName && <span className=" text-[#FFE83D]">Enter First Name *</span> }
                    </div>
                    <div className="flex flex-col gap-2 lg:w-[48%]">
                        <label htmlFor="lastName" className="text-[14px] text-[#F1F2FF]">
                            Last Name
                        </label>
                        <input type="text" name="lastName" id="lastName" placeholder="Enter last name" className="rounded-lg bg-[#2C333F] p-3 text-[16px] leading-[24px] text-[#F1F2FF] shadow-[0_1px_0_0] shadow-[#fff]/50 placeholder:text-[#6E727F] focus:outline-none"  
                            {...register("lastName")}
                        />
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input type="email" name="email" id="email" placeholder="Enter email address" className="rounded-lg bg-[#2C333F] p-3 text-[16px] leading-[24px] text-[#F1F2FF] shadow-[0_1px_0_0] shadow-[#fff]/50 placeholder:text-[#6E727F] focus:outline-none"  
                        {...register("email",{required:true})}
                    />
                        { errors.email && <span className=" text-[#FFE83D]">Enter Email *</span> }
                </div>
                <div className='flex flex-col gap-2'>
                    <label htmlFor="contactNumber" className="text-[14px] text-[#F1F2FF]">
                        Contact Number
                    </label>
                    <div className='flex gap-5'>
                        ...
                        <div className='flex w-[calc(100%-90px)] flex-col gap-2'>
                            <input type="tel" name="contactNumber" id="contactNumber" placeholder="12345 67890" className="rounded-lg bg-[#2C333F] p-3 text-[16px] leading-[24px] text-[#F1F2FF] shadow-[0_1px_0_0] shadow-[#fff]/50 placeholder:text-[#6E727F] focus:outline-none" 
