        ...
        <div>
            ...
            <div className="flex flex-col gap-5 lg:flex-row">
                ...
                <div className="flex flex-col gap-2 lg:w-[48%]">
                    ...
                    <input type="text" name="lastName" id="lastName" placeholder="Enter last name" className="rounded-lg bg-[#2C333F] p-3 text-[16px] leading-[24px] text-[#F1F2FF] shadow-[0_1px_0_0] shadow-[#fff]/50 placeholder:text-[#6E727F] focus:outline-none"  {...register("lastName")}/>
